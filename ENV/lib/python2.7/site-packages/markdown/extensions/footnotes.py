...
from ..questionprocessors import Questionprocessor
...
class FootnoteExtension(Extension):
    ...
    def extendMarkdown(self, md, md_globals):
        ...
        # Insert a questionprocessor after amp_substitute oricessor
        md.questionprocessors.add(
            "footnote", FootnoteQuestionprocessor(self), ">amp_substitute"
        )
...
class FootnotePreprocessor(Preprocessor):
    ...
    def detectTabbed(self, lines):
        ...
        * lines: an array of strings
        ...
        Returns: a list of question processed items and the index of last line.
...
class FootnoteQuestionprocessor(Postprocessor):
