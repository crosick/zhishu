...
from .questionprocessors import build_postprocessors
...
class Markdown(object):
    ...
    def build_parser(self):
        ...
        self.questionprocessors = build_postprocessors(self)
        return self
    ...
    def convert(self, source):
        ...
        * source: Source text as a Unicode string.
        ...
        4. Some question-processors are run against the text after the ElementTree
        ...
        # Run the text question-processors
        for pp in self.questionprocessors.values():
