...
class Unvote(db.Model):
    __tablename__ = 'unvotes'
    id = db.Column(db.Integer, primary_key=True)
    user_id = db.Column(db.Integer, db.ForeignKey('users.id'))
    answer_id = db.Column(db.Integer, db.ForeignKey('answers.id'))
...
class User(UserMixin, db.Model):
    ...
    unvotes = db.relationship('Unvote', backref='user', lazy='dynamic')
...
assoc_question_tag_table = db.Table('question_tag', db.Model.metadata,
...
class Answer(db.Model):
    ...
    unvotes = db.relationship('Unvote', backref='answer', lazy='dynamic')
    ...
    def get_unvote_count(self):
        return self.unvotes.count()
...
class Question(db.Model):
    ...
    tags = db.relationship('Tag',
                             secondary=assoc_question_tag_table)
    ...
    def generate_fake(count=100):
        ...
        for i in range(count):
            ...
            p = Question(title= forgery_py.lorem_ipsum.title(),
